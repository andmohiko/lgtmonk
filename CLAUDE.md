...
@docs/spec.md を読み込むこと。読んだら「📛spec.mdを読みました。」と表示すること

## モジュール構成

- apps/extension - Chrome拡張アプリ。Reactとvite-plugin-web-extensionを使用
- apps/functions - Cloud Functions for Firebaseのディレクトリ。サーバー側で実行したい処理を実装する
- apps/web - Webアプリのフロントエンド。Tanstack Startで実装している
